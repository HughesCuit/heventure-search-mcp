...
### Changed
- 升级核心依赖到最新稳定版
  - aiohttp 3.8.0 → 3.13.5
  - beautifulsoup4 4.11.0 → 4.14.3
  - mcp 1.0.0 → 1.27.1
...
### 改进
- ✅ **修复 server_version 与项目版本同步**: server.py 中的 server_version 现在使用 `__version__` 变量，与 pyproject.toml 保持一致
...
- ⚡ **多引擎选择**: 支持选择 DuckDuckGo、必应或同时使用两个搜索引擎
...
### 新增
- 🔍 **网页搜索功能**: 使用 DuckDuckGo 进行网页搜索，无需 API key
- 📄 **网页内容获取**: 获取指定 URL 的网页内容并转换为 Markdown 格式
- 🌐 **中文搜索支持**: 优化的中文搜索体验
